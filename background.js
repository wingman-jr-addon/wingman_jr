...
function bkPickThreshold(pageHost) {
    return ssSuggestThresholdStdDevAdaptive(pageHost, ROC_trustedRoc.threshold, 0.025, ROC_untrustedRoc.threshold);
}
...
async function bkImageListenerNormal(details, mimeType) {
    ...
    processor.postMessage({
        ...
        url: details.url,
        //threshold: BK_zoneThreshold,
        threshold: bkPickThreshold(bkExtractRootDomain(bkGetTopmostUrl(details))),
