 ...
 * =============================================================================
 */
/// <amd-module name="@tensorflow/tfjs-tflite/dist/tflite_task_library_client/object_detector" />
 ...
 */
export declare class ObjectDetector extends BaseTaskLibraryClient {
    protected instance: TaskLibraryObjectDetector;
    constructor(instance: TaskLibraryObjectDetector);
    static create(model: string | ArrayBuffer, options?: ObjectDetectorOptions): Promise<ObjectDetector>;
    detect(input: ImageData | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement): Detection[];
}
